...
`order_status_name` varchar(50) NOT NULL,
  FOREIGN KEY (`customer_id`) REFERENCES `dim_customers` (`customer_key`),
  FOREIGN KEY (`employee_id`) REFERENCES `dim_employees` (`employee_key`),
  FOREIGN KEY (`shipper_id`) REFERENCES `dim_shippers` (`shipper_key`)
